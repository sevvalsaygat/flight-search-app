...
type MiniFlightItemPropTypes = {
  flight: FlightType;
};

const MiniFlightItem: React.FC<MiniFlightItemPropTypes> = ({ flight }) => {
  return (
    <div className="flex mx-auto items-center justify-center mb-2 ml-2">
      <div className="flex flex-row justify-center items-center gap-5 w-full p-7 border border-rose-200 cursor-pointer hover:bg-rose-100 shadow-sm rounded-md">
        ...
        <div className="flex flex-row mr-5 justify-center items-center gap-3">
          ...
          <div className="text-base font-semibold text-purple-900">
            <div className="flex flex-col items-center text-xs">
              {date.getHourInfo(flight.arrival)}
            </div>
            {flight.to.refCode}
          </div>
        </div>
